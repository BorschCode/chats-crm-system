...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'services.telegram.bot_token' => 'string',
            'services.telegram.webhook_url' => 'string',
            'services.telegram.mode' => 'string',
            'services.whatsapp.access_token' => 'string',
            'services.whatsapp.phone_number_id' => 'string',
            'services.whatsapp.webhook_verify_token' => 'string',
            'services.whatsapp.api_version' => 'string',
            'services.whatsapp.business_account_id' => 'string',
            'services.whatsapp.api_base_url' => 'string',
...
'services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.telegram.bot_token','services.telegram.webhook_url','services.telegram.mode',
'services.whatsapp.access_token','services.whatsapp.phone_number_id','services.whatsapp.webhook_verify_token','services.whatsapp.api_version','services.whatsapp.business_account_id',
'services.whatsapp.api_base_url','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'debugbar.route_domain','debugbar.theme','debugbar.debug_backtrace_limit','boost.enabled','boost.browser_logs_watcher',
'mcp.redirect_domains','livewire.class_namespace','livewire.view_path','livewire.layout','livewire.lazy_placeholder',
...
'boost.browser-logs','livewire.update','generated::pLmppw5xq6UmSXUF','generated::ZE48EMtaLpso4QJ3','livewire.upload-file',
'livewire.preview-file','generated::SvV8yDx9x8qbmVEV','home','groups.list','items.list',
'items.by.group','item.show','storage.local',);
        registerArgumentsSet('views', 
'components.layouts.app','livewire.group-list','livewire.item-list','livewire.item-show','volt-livewire::group-list',
'volt-livewire::item-list','volt-livewire::item-show','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
...
'BCRYPT_ROUNDS','APP_PORT','VITE_PORT','LOG_CHANNEL','LOG_STACK',
'LOG_DEPRECATIONS_CHANNEL','LOG_LEVEL','DB_CONNECTION','DB_HOST','DB_PORT',
'DB_PASSWORD','DB_DATABASE','DB_USERNAME','SESSION_DRIVER','SESSION_LIFETIME',
'SESSION_ENCRYPT','SESSION_PATH','SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK',
'QUEUE_CONNECTION','CACHE_STORE','MEMCACHED_HOST','MAIL_MAILER','MAIL_SCHEME',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','WWWUSER','WWWGROUP','FORWARD_DB_PORT',
'TELEGRAM_BOT_TOKEN','TELEGRAM_MODE','TELEGRAM_WEBHOOK_URL','WHATSAPP_ACCESS_TOKEN','WHATSAPP_PHONE_NUMBER_ID',
'WHATSAPP_WEBHOOK_VERIFY_TOKEN','WHATSAPP_API_VERSION','WHATSAPP_BUSINESS_ACCOUNT_ID',);
